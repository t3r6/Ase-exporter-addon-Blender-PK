...
class cSubMaterials:
    def __init__( self, material_list ):
        ...
        inputVal = principled.inputs[12] # specular 
        ...
        valTransp = principled.inputs[4]  # alpha value input
        ...
        self.transparency = aseFloat(valTransp.default_value) #aseFloat( 0.0 )  # slot.translucency * slot.alpha
...
class cMaterial:
    def __init__( self, slot ):
        ...
        nodes = material.node_tree.nodes
        principled = next(n for n in nodes if n.type == 'BSDF_PRINCIPLED')
        inputVal= principled.inputs[12] # or .inputs['Specular']
